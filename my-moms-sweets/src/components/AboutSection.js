  ...
  return (
    <div className="about-container">
      ...
      <div className="about-content">
        <p>
          Meet Safiyo, a dedicated and passionate chef who specializes in making traditional Somali Halwa.
        ...
        <img src={momMakingHalwa} alt="Safiyo making Halwa" className="about-image"/>
      </div>
    </div>
  );
};
